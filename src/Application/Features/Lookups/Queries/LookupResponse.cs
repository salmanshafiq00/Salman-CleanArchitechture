...
public record LookupResponse
{
    ...
    public dynamic DataSources { get; set; } = new ExpandoObject();
    ...
    public static IReadOnlyCollection<DataFieldModel> DataFields = [
        ...
        new DataFieldModel{ Field = "parentName", Header = "Parent Name", FieldType = TField.TMultiSelect, DSName = string.Empty, DbField = "P.Name", IsSortable = true, IsGlobalFilterable = true, IsFilterable = true, Visible = true, SortOrder = 3 },
