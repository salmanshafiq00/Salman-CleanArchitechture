...
public record LookupResponse
{
    ...
    public static IReadOnlyCollection<DataFieldModel> DataFields = [
        ...
        new DataFieldModel{ Field = "parentName", Header = "Parent Name", FieldType = TField.TMultiSelect, DSName = "parentList", DbField = "P.Name", IsSortable = true, IsGlobalFilterable = true, IsFilterable = true, Visible = true, SortOrder = 3 },
