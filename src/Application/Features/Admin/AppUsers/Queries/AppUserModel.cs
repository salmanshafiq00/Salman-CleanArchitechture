...
public record AppUserModel
{
    ...
    public static IReadOnlyCollection<DataFieldModel> DataFields = [
        ...
        new DataFieldModel{ Field = "roles", Header = "Roles", DbField = "UR.RoleId", FieldType = TField.TMultiSelect, DSName = "roleSelectList", IsSortable = true,  IsGlobalFilterable = true, IsFilterable = true, Visible = true, SortOrder = 8 },
    ];
