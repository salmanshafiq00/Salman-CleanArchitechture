...
namespace CleanArchitechture.Application.UnitTests.Common.Behaviours;
...
public class RequestLoggerTests
{
    ...
    public async Task ShouldCallGetUserNameAsyncOnceIfAuthenticated()
    {
        ...
        _identityService.Verify(i => i.GetUserNameAsync(It.IsAny<string>(), new CancellationToken()), Times.Once);
    }
    ...
    public async Task ShouldNotCallGetUserNameAsyncOnceIfUnauthenticated()
    {
        ...
        _identityService.Verify(i => i.GetUserNameAsync(It.IsAny<string>(), new CancellationToken()), Times.Never);
    }
}
